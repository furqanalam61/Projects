...
const ItemDivider = class {
    ...
    render() {
        const mode = core.getIonMode(this);
        return (core.h(core.Host, { class: Object.assign(Object.assign({}, theme.createColorClasses(this.color)), { [mode]: true, 'item-divider-sticky': this.sticky, 'item': true }) }, core.h("slot", { name: "start" }), core.h("div", { class: "item-divider-inner" }, core.h("div", { class: "item-divider-wrapper" }, core.h("slot", null)), core.h("slot", { name: "end" }))));
    }
    get el() { return core.getElement(this); }
