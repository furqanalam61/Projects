...
const patchBrowser = async () => {
    ...
    // @ts-ignore
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('core-5bb2836d.js', document.baseURI).href));
...
const global0 = () => {
    ...
    const configObj = Object.assign(Object.assign(Object.assign(Object.assign({}, config.configFromSession(win)), { persistConfig: false }), Ionic.config), config.configFromURL(win));
