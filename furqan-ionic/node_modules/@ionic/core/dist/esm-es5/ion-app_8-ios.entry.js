...
import { r as registerInstance, d as getIonMode, h, H as Host, e as getElement, c as createEvent, f as readTask, w as writeTask } from './core-57385ee8.js';
import { b as config, i as isPlatform } from './config-3c7f3790.js';
import { b as rIC, c as clamp } from './helpers-e0fdb9d0.js';
...
import { t as transition } from './index-cd19f367.js';
    ...
    App.prototype.componentDidLoad = function () {
        {
            rIC(function () {
                ...
                if (!config.getBoolean('_testing')) {
                    import('./tap-click-1f9d539e.js').then(function (module) { return module.startTapClick(config); });
                }
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-7ab22cb8.js').then(function (module) { return module.startStatusTap(); });
                }
                if (config.getBoolean('inputShims', needInputShims())) {
                    import('./input-shims-7a8a317c.js').then(function (module) { return module.startInputShims(config); });
                }
...
var handleToolbarIntersection = function (ev, mainHeaderIndex, scrollHeaderIndex) {
    writeTask(function () {
        ...
        var isPageTransitioning = intersectionArea > 0 && (intersection.left !== event.rootBounds.left || intersection.right !== event.rootBounds.right);
