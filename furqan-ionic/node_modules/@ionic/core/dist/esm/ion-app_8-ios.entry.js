    ...
    componentDidLoad() {
        {
            rIC(() => {
                ...
                if (!config.getBoolean('_testing')) {
                    import('./tap-click-1f9d539e.js').then(module => module.startTapClick(config));
                }
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-7ab22cb8.js').then(module => module.startStatusTap());
                }
                if (config.getBoolean('inputShims', needInputShims())) {
                    import('./input-shims-7a8a317c.js').then(module => module.startInputShims(config));
                }
